  ...
  return (
    ...
    >
      ...
      >
        ...
        "
        >
          <section onClick={() => navigate(-1)} className="w-16 h-5 flex items-center cursor-pointer ">
        ...
        >
          ...
          >
            ...
            <section className="w-full flex flex-col mt-3 relative">
              ...
              />
              <p onClick={viewPassword} className="absolute cursor-pointer text-tBlack text-t15px right-4 bottom-3.5">Show</p>
            </section>

            <section className="flex mt-3">
                <input type="checkbox" required />
                <p className="ml-4 text-t16px text-tGreyFM ">I agree to terms & conditions</p>
            </section>

            <section className="w-full mt-5">
                <button className="w-full text-t16px py-3.5 px-4 rounded-md bg-tBlueF hover:shadow-lg font-regular text-tWhiteF ">Register Account</button>
