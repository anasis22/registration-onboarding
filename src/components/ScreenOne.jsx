          ...
          >
            <Link to="ScreenTwo">
              <section className="w-full cursor-pointer bg-tWhiteBH flex items-center justify-center rounded-md border-bw border-solid border-tBlueF hover:shadow-lg p-4 ">
                <img className="w-10 h-10" src={Individual} alt="individual" />
                ...
                <img
                  className="laptop:ml-0 ipad:ml-2 mobile:ml-4"
                  src={RightArrow}
                  alt="right"
                />
              </section>
            ...
            <Link to="ScreenTwo">
              <section
                onClick={clickToBorder}
                className={`w-full cursor-pointer flex items-center justify-center rounded-md border-bw border-solid p-4 mt-6 shadow-md hover:shadow-lg ${
                  myborder && "border border-tBlueF"
                }`}
              >
                <img className="w-10 h-10" src={Business} alt="individual" />
                <section className={`ml-6`}>
                  <h3 className="text-tNormalMin font-medium font-tInterFont">
                    Business
                  </h3>
                ...
                <img
                  src={`${myborder ? RightArrow : RightArrowWhite}`}
                  alt="right"
                />
              </section>
            </Link>
